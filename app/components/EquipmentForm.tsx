...
export default function EquipmentForm() {
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold">Dodaj spravu za vežbanje</h2>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            name="category"
            defaultValue="OSTALO"
            className="rounded-lg border border-zinc-300 bg-white px-3 py-2.5 text-sm outline-none dark:border-zinc-700 dark:bg-zinc-900"
          >
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="eq-quantity" className="text-sm font-medium">
            Količina
          </label>
          <input
            id="eq-quantity"
        ...
        <div className="flex flex-col gap-1.5 sm:col-span-2">
          ...
          <textarea
            ...
            maxLength={500}
            rows={3}
            placeholder="Kratak opis sprave..."
      ...
      >
        {pending ? "Dodavanje..." : "Dodaj spravu"}
      </button>
    </form>
  );
}